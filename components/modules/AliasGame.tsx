...
// ─── Word Bank ────────────────────────────────────────────────────────────────
const WORD_BANK: Record<'easy' | 'medium' | 'hard', string[]> = {
  easy: [
    'תקציב', 'הוצאה', 'הכנסה', 'חיסכון', 'מחיר', 'קנייה', 'הנחה', 'חוב',
    'בנק', 'מזומן', 'ביטוח', 'שכר דירה', 'חשבון', 'מבצע', 'ארנק',
    'כרטיס אשראי', 'קניות', 'תשלום', 'רשימת קניות', 'כסף', 'מס',
    'שכר', 'הלוואה', 'ריבית', 'חנות', 'מוצר', 'לקוח', 'בעל חנות',
    'קופה', 'תשר', 'חשמל', 'מים', 'אוכל', 'בגדים', 'נסיעות',
  ],
  medium: [
    'הוצאה קבועה', 'הוצאה משתנה', 'תקציב מאוזן', 'חריגה בבנק',
    'תיעדוף הוצאות', 'השוואת מחירים', 'מחיר ליחידה', 'מינוס בבנק',
    'תשלומים', 'קופת חיסכון', 'יתרה בחשבון', 'עמלה בנקאית',
    'צרכן חכם', 'מודל חצ"ר', 'הוצאה בלתי צפויה', 'חיסכון חודשי',
    'תזרים מזומנים', 'מחיר עלות', 'מחיר מכירה', 'רווח נקי',
    'תשלום מינימום', 'תקרת אשראי', 'חיסכון לחירום', 'יעד חיסכון',
    'ניהול תקציב', 'הוצאה מיותרת', 'קנייה אימפולסיבית', 'חוזה שירות',
    'ביטול מנוי', 'ספירת הוצאות', 'מודל 50-30-20', 'הכנסה פסיבית',
  ],
  hard: [
    'אינפלציה', 'ריבית דריבית', 'פנסיה', 'ביטוח לאומי', 'תלוש שכר',
    'מס הכנסה', 'השקעה', 'מניות', 'קרן חיסכון', 'נכס פיננסי',
    'התחייבות כספית', 'תרחיש כלכלי', 'קריסת תקציב', 'פיזור סיכונים',
    'תכנון פיננסי', 'ניהול סיכונים', 'גרעון תקציבי', 'עודף תקציבי',
    'שוק ההון', 'תשואה על השקעה', 'ריבית ריאלית', 'ריבית נומינלית',
    'כוח קנייה', 'שחיקת ערך הכסף', 'פוליסת ביטוח', 'קרן פנסיה',
    'ניידות פנסיונית', 'קצבת פרישה', 'מס רווחי הון', 'קרן השתלמות',
  ],
};
...
function getDeckForDifficulty(difficulty: 'easy' | 'medium' | 'hard' | 'mixed'): string[] {
  if (difficulty === 'mixed') {
